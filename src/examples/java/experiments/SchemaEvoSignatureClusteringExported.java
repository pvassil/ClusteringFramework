...
public class SchemaEvoSignatureClusteringExported {

    public static void main(String[] args) throws Exception {
        String inputFile    = "src/test/resources/input/schemaEvo/Level11SgnNoGestation_try03_Abridged.tsv"; //input file
		...
		try {
			schemaSignaturesLoaded = loader.load(inputFile, "\t");
		} catch (IOException e) {
        ...
        System.out.println(hacManager.executeAndExport());
        System.out.println("======\n\n");
        ...
        dbscanParams.put("eps", "0.5");
        dbscanParams.put("minPts", "5");
        ...
        System.out.println(dbscanManager.executeAndExport());
        System.out.println("======\n\n");
        ...
        ClusterSet kMedoidClustersDTW = kMedoidsManagerDTW.executeAndExport();
      ...
      ClusterSet kMedoidClusters = kMedoidsManager.executeAndExport();
